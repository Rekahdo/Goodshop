package com.rekahdo.goodshop.phone_service.validations.validators;
...
public class CountryCodeValidator implements ConstraintValidator<CountryCode, String> {
    ...
    public boolean isValid(String value, ConstraintValidatorContext context) {
        ...
        if(value.startsWith("0")) {
            ...
            context.buildConstraintViolationWithTemplate("Country code should not start with 0").addConstraintViolation();
            return false;
        }
