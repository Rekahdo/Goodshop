package com.rekahdo.goodshop.authentication_service.exceptions.handlers;

import com.fasterxml.jackson.core.JsonProcessingException;
import com.rekahdo.goodshop.authentication_service.exceptions.model.ErrorResponse;
...
public class Api_ExceptionHandler {
    ...
    public ResponseEntity<?> handleFeignNotFoundException(FeignException ex) throws JsonProcessingException {
        ErrorResponse errorResponse = ErrorResponse.getInstance(ex);
        return ResponseEntity.status(errorResponse.getStatus()).body(errorResponse.view());
    }

    @ExceptionHandler({FeignException.BadRequest.class})
    public ResponseEntity<?> handleFeignBadRequestException(FeignException ex) throws JsonProcessingException {
        ErrorResponse errorResponse = ErrorResponse.getInstance(ex);
        return ResponseEntity.status(errorResponse.getStatus()).body(errorResponse.view());
    }
