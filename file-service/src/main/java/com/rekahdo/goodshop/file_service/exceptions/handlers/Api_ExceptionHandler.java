package com.rekahdo.goodshop.file_service.exceptions.handlers;

import com.fasterxml.jackson.core.JsonProcessingException;
import com.rekahdo.goodshop.file_service.exceptions.model.ErrorResponse;
...
public class Api_ExceptionHandler {
    ...
    public ResponseEntity<?> handleFeignServerErrorException(FeignException.NotFound ex) throws JsonProcessingException {
    ...
    public ResponseEntity<?> handleMaxUploadSizeExceededException(MaxUploadSizeExceededException ex) {
        ErrorResponse errorResponse = new ErrorResponse(ex, ex.getStatusCode());
        return ResponseEntity.status(errorResponse.getStatus()).body(errorResponse.view());
    }
