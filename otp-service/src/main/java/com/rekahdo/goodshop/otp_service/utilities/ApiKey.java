package com.rekahdo.goodshop.otp_service.utilities;
...
public class ApiKey {
    ...
    public static final String MESSAGING_SERVICE = "access-to-1050-port";
    public static final String PHONE_SERVICE = "access-to-1070-port";
    public static final String SERVICE_KEY = "access-to-1040-port";
